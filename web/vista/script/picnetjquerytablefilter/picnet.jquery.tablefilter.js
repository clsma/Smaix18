...
(function(jQuery) {
    jQuery.fn.tableFilter = function(_options) {
        ...
        {               
            ...
            switch (filterType) 
            {         
                case 'text': return "<input type='text' id='filter_" + colIdx + "' class='filter' title='FILTRAR'/>";
    ...
    jQuery.fn.tableFilter.filterToolTipMessage = "FILTRO GENERAL";
