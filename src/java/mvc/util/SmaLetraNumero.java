...
public class SmaLetraNumero {
    ...
    public SmaLetraNumero() {
        numero = 0;
        flag = 0;
    }

    public SmaLetraNumero(int n) {
        numero = n;
        flag = 0;
    }

    private String unidad(Double numero) {
    ...
    private String cienmillon(Double numero) {
        if (numero == 100000000) {
            num_letradmm = "Cien millones";
        }
        if (numero > 100000000 && numero < 200000000) {
            flag = 1;
            num_letradmm = decena(numero / 10000000).concat(" millones ").concat(cienmiles(numero % 10000000)); 
        }                                   
      ...
      private String milmillon(Double numero) {
        ...
        if (numero > 1000000000 && numero < 2000000000) {
            flag = 1;
            num_letradmm = miles(numero/1000000).concat(" millones ").concat(cienmillon(numero % 1000000)); 
            System.out.println(num_letradmm);
        }                                   
        if (numero >= 2000000000 && numero < 1000000000) {
            flag = 1;
            num_letradmm = centena(numero / 1000000).concat(" milllones ").concat(cienmillon(numero % 1000000));
            System.out.println(num_letradmm);
        }
        if (numero < 1000000000) {
            num_letradmm = cienmillon(numero);
        }
    ...
    public String convertirLetras(Double numero) {
        num_letras = milmillon(numero).toUpperCase()+ "/ PESOS";
        return num_letras;
    }
}
